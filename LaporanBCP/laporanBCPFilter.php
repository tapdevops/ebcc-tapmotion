	  ...
	  <tr>
		...
		<td height="45" colspan="3" valign="bottom" style="border-bottom:solid #000">PERIODE</td>
              ...
              <tr>
				...
				<td width="100" align="left" valign="top"><input type="radio" name="rbtn_type" value="Detail" checked="checked">Detail
              ...
              <tr>
				...
				<td align="right" colspan='3'><input type="submit" name="button" id="button" value="TAMPILKAN" style="visibility:visible; width:120px; height: 30px" onclick="formSubmit(1)"/></td>
              </tr>
