...
$tes = "none";
	...
	if($username == ""){
		...
		$sql_default_Nama_Afd_Supir = "select te.emp_name, ta.id_afd from t_employee te
		...
		$Nama_TM1	= "";
		$Afd_TM1  	= "";
		$sql_default_Nama_Afd_TM1 = "select te.emp_name, ta.id_afd from t_employee te
		...
		$Nama_TM2	= "";
		$Afd_TM2 	= "";
		$sql_default_Nama_Afd_TM2 = "select te.emp_name, ta.id_afd from t_employee te
		...
		$Nama_TM3	= "";
		$Afd_TM3  	= "";
		$sql_default_Nama_Afd_TM3 = "select te.emp_name, ta.id_afd from t_employee te
...
<table width="1079" height="390" border="0" align="center">
  <tr>
  ...
  <tr>
    <th height="97" scope="row" align="center"><form id="form1" name="form1" method="post" action="KoreksiNABSelect.php">
      <table width="1031" border="0" style="border:solid #556A29" bgcolor="#C4D59E">
      <tr>
        <td><table width="1031" border="0" style="border:solid #556A29" bgcolor="#C4D59E">
          <tr>
          ...
          <tr>
            ...
            <td width="8">:</td>
            <td width="303"><input name="No_NABLabel" type="text" id="No_NABLabel" value="<?=$sNO_NAB[0]?>" style="background-color:#CCC; width:300px; height:25px; font-size:15px" onmousedown="return false"/></td>
          </tr>
          <tr>
