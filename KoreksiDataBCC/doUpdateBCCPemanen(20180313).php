							...
							if($ID_BA_tdrp!=$id_bafd) {
								...
								if ($cek_id_rencana_THP == "") {
									if($plan_ID==$ID_RENCANA) {
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_TPH = 'WEBSITE', STATUS_DETIC = 'WEBSITE' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$ID_RENCANA."'";
										...
										if($result_THP>0) {
											...
											$ins_log_hasilpanen = "INSERT INTO T_LOG_HASIL_PANEN
												(INSERTUPDATE, TGL_CREEDIT, NIK_CREEDITOR, LOGIN_NAME_CREEDITOR, ON_TABLE, ON_NO_BCC, ON_KODE_DELIVERY_TICKET, NEW_VALUE_STATUS_BCC, OLD_VALUE_STATUS_BCC, NEW_VALUE_NO_REKAP_BCC, OLD_VALUE_NO_REKAP_BCC, CREEDIT_FROM, SYNC_SERVER, NEW_VALUE_ID_RENCANA, OLD_VALUE_ID_RENCANA, NEW_VALUE_STATUS_TPH, OLD_VALUE_STATUS_TPH)
												VALUES
												('UPDATE', SYSDATE, '$NIK', '$Login_Name', 't_hasil_panen', '".$No_BCC."', 'NULL', 'NULL', 'NULL', '".$new_rekap."', '".$No_Rekap."', 'Website' , SYSDATE, '".$ID_RENCANA."', '".$oldrencana1."', '".$newTPH."', '".$old_tph."')";
									  ...
									  (ID_RENCANA, NO_REKAP_BCC, NO_TPH, NO_BCC, KODE_DELIVERY_TICKET, LATITUDE, LONGITUDE, PICTURE_NAME, STATUS_BCC, ID_NAB_TGL, IMAGE_FILE, UPDATE_TIME_CLOB, CETAK_BCC, CETAK_DATE, VALIDASI_BCC, VALIDASI_DATE, STATUS_TPH)
									SELECT '".$plan_ID."', '".$new_rekap."', '".$newTPH."', t.NO_BCC, t.KODE_DELIVERY_TICKET, t.LATITUDE, t.LONGITUDE, t.PICTURE_NAME, t.STATUS_BCC, t.ID_NAB_TGL, t.IMAGE_FILE, t.UPDATE_TIME_CLOB, t.CETAK_BCC, t.CETAK_DATE, t.VALIDASI_BCC, t.VALIDASI_DATE, t.STATUS_TPH
									 ...
									 WHERE t.NO_REKAP_BCC = '".$No_Rekap."' AND t.NO_BCC = '".$No_BCC."' AND t.ID_RENCANA = '".$ID_RENCANA."'";
										...
										if($result_THP>0) {
											...
											$ins_log_hasilpanen = "INSERT INTO T_LOG_HASIL_PANEN
												(INSERTUPDATE, TGL_CREEDIT, NIK_CREEDITOR, LOGIN_NAME_CREEDITOR, ON_TABLE, ON_NO_BCC, ON_KODE_DELIVERY_TICKET, NEW_VALUE_STATUS_BCC, OLD_VALUE_STATUS_BCC, NEW_VALUE_NO_REKAP_BCC, OLD_VALUE_NO_REKAP_BCC, CREEDIT_FROM, SYNC_SERVER, NEW_VALUE_ID_RENCANA, OLD_VALUE_ID_RENCANA, NEW_VALUE_STATUS_TPH, OLD_VALUE_STATUS_TPH)
												VALUES
												('UPDATE', SYSDATE, '$NIK', '$Login_Name', 't_hasil_panen', '".$No_BCC."', 'NULL', 'NULL', 'NULL', '".$new_rekap."', '".$No_Rekap."', 'Website' , SYSDATE, '".$plan_ID."', '".$oldrencana1."', '".$newTPH."', '".$old_tph."')";
											$result_ins_log_hasilpanen = oci_parse($con, $ins_log_hasilpanen);
											oci_execute($result_ins_log_hasilpanen, OCI_DEFAULT);
											//echo $ins_log_hasilpanen."<br><br>";
											}
								...
								if ($cek_id_rencana_THP == ""){
									if($plan_ID==$ID_RENCANA){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$no_rekap_bcc_value."', NO_TPH = '".$newTPH."', STATUS_TPH = 'WEBSITE' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$ID_RENCANA."'";
										$result_THP = num_rows($con, $query_ins_thp);
										...
										if($result_THP>0){
											...
											$ins_log_hasilpanen = "INSERT INTO T_LOG_HASIL_PANEN
												(INSERTUPDATE, TGL_CREEDIT, NIK_CREEDITOR, LOGIN_NAME_CREEDITOR, ON_TABLE, ON_NO_BCC, ON_KODE_DELIVERY_TICKET, NEW_VALUE_STATUS_BCC, OLD_VALUE_STATUS_BCC, NEW_VALUE_NO_REKAP_BCC, OLD_VALUE_NO_REKAP_BCC, CREEDIT_FROM, SYNC_SERVER, NEW_VALUE_ID_RENCANA, OLD_VALUE_ID_RENCANA, NEW_VALUE_STATUS_TPH, OLD_VALUE_STATUS_TPH)
												VALUES
												('UPDATE', SYSDATE, '$NIK', '$Login_Name', 't_hasil_panen', '".$No_BCC."', 'NULL', 'NULL', 'NULL', '".$no_rekap_bcc_value."', '".$No_Rekap."', 'Website' , SYSDATE, '".$ID_RENCANA."', '".$oldrencana1."', '".$newTPH."', '".$old_tph."')";
											$result_ins_log_hasilpanen = oci_parse($con, $ins_log_hasilpanen);
											oci_execute($result_ins_log_hasilpanen, OCI_DEFAULT);
											//echo $ins_log_hasilpanen."<br><br>";
										}
										...
										//Edited by Ardo 12 Dec 2016 : Issue Log - Koreksi BCC menghilangkan log cetak BCC
										$query_ins_thp = "INSERT INTO T_HASIL_PANEN
										  (ID_RENCANA, NO_REKAP_BCC, NO_TPH, NO_BCC, KODE_DELIVERY_TICKET, LATITUDE, LONGITUDE, PICTURE_NAME, STATUS_BCC, ID_NAB_TGL, UPDATE_TIME_CLOB, CETAK_BCC, CETAK_DATE, VALIDASI_BCC, VALIDASI_DATE, STATUS_TPH)
										SELECT '".$plan_ID."', '".$no_rekap_bcc_value."', '".$newTPH."', t.NO_BCC, t.KODE_DELIVERY_TICKET, t.LATITUDE, t.LONGITUDE, t.PICTURE_NAME, t.STATUS_BCC, t.ID_NAB_TGL, t.UPDATE_TIME_CLOB, t.CETAK_BCC, t.CETAK_DATE, t.VALIDASI_BCC, t.VALIDASI_DATE, t.STATUS_TPH
										  FROM T_HASIL_PANEN t
										 WHERE t.NO_REKAP_BCC = '".$No_Rekap."' AND t.NO_BCC = '".$No_BCC."' AND t.ID_RENCANA = '".$ID_RENCANA."'";
										$result_THP = num_rows($con, $query_ins_thp);
										//echo $query_ins_thp.";<br><br>";
										if($result_THP>0){
											if($No_Rekap<>$no_rekap_bcc_value or $plan_ID<>$ID_RENCANA){
												...
												$ins_log_hasilpanen = "INSERT INTO T_LOG_HASIL_PANEN
													(INSERTUPDATE, TGL_CREEDIT, NIK_CREEDITOR, LOGIN_NAME_CREEDITOR, ON_TABLE, ON_NO_BCC, ON_KODE_DELIVERY_TICKET, NEW_VALUE_STATUS_BCC, OLD_VALUE_STATUS_BCC, NEW_VALUE_NO_REKAP_BCC, OLD_VALUE_NO_REKAP_BCC, CREEDIT_FROM, SYNC_SERVER, NEW_VALUE_ID_RENCANA, OLD_VALUE_ID_RENCANA, NEW_VALUE_STATUS_TPH, OLD_VALUE_STATUS_TPH)
													VALUES
													('UPDATE', SYSDATE, '$NIK', '$Login_Name', 't_hasil_panen', '".$No_BCC."', 'NULL', 'NULL', 'NULL', '".$no_rekap_bcc_value."', '".$No_Rekap."', 'Website' , SYSDATE, '".$plan_ID."', '".$oldrencana1."', '".$newTPH."', '".$old_tph."')";
												$result_ins_log_hasilpanen = oci_parse($con, $ins_log_hasilpanen);
												oci_execute($result_ins_log_hasilpanen, OCI_DEFAULT);
												//echo $ins_log_hasilpanen."<br><br>";
											}
							...
							if($ID_BA_tdrp!=$id_bafd){
								...
								if ($cek_id_rencana_THP == ""){
									...
									if($oldrencana==$new_id_rencana){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_TPH = 'WEBSITE' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$oldrencana."'";
										$result_THP = num_rows($con, $query_ins_thp);
										if($result_THP>0){
											//Added by Ardo, 22-2-2016 : Insert into t_log_hasilpanen
											$ins_log_hasilpanen = "INSERT INTO T_LOG_HASIL_PANEN
												(INSERTUPDATE, TGL_CREEDIT, NIK_CREEDITOR, LOGIN_NAME_CREEDITOR, ON_TABLE, ON_NO_BCC, ON_KODE_DELIVERY_TICKET, NEW_VALUE_STATUS_BCC, OLD_VALUE_STATUS_BCC, NEW_VALUE_NO_REKAP_BCC, OLD_VALUE_NO_REKAP_BCC, CREEDIT_FROM, SYNC_SERVER, NEW_VALUE_ID_RENCANA, OLD_VALUE_ID_RENCANA, NEW_VALUE_STATUS_TPH, OLD_VALUE_STATUS_TPH)
												VALUES
												('UPDATE', SYSDATE, '$NIK', '$Login_Name', 't_hasil_panen', '".$No_BCC."', 'NULL', 'NULL', 'NULL', '".$new_rekap."', '".$No_Rekap."', 'Website' , SYSDATE, '".$oldrencana1."', '".$oldrencana1."', '".$newTPH."', '".$old_tph."')";
											$result_ins_log_hasilpanen = oci_parse($con, $ins_log_hasilpanen);
											oci_execute($result_ins_log_hasilpanen, OCI_DEFAULT);
											//echo $ins_log_hasilpanen."<br><br>";
										}
										...
										$query_ins_thp = "INSERT INTO T_HASIL_PANEN
			  (ID_RENCANA, NO_REKAP_BCC, NO_TPH, NO_BCC, KODE_DELIVERY_TICKET, LATITUDE, LONGITUDE, PICTURE_NAME, STATUS_BCC, ID_NAB_TGL, IMAGE_FILE, UPDATE_TIME_CLOB, CETAK_BCC, CETAK_DATE, VALIDASI_BCC, VALIDASI_DATE, STATUS_TPH)
			SELECT '".$new_id_rencana."', '".$new_rekap."', '".$newTPH."', t.NO_BCC, t.KODE_DELIVERY_TICKET, t.LATITUDE, t.LONGITUDE, t.PICTURE_NAME, t.STATUS_BCC, t.ID_NAB_TGL, t.IMAGE_FILE, t.UPDATE_TIME_CLOB, t.CETAK_BCC, t.CETAK_DATE, t.VALIDASI_BCC, t.VALIDASI_DATE, t.STATUS_TPH
			  FROM T_HASIL_PANEN t
			 WHERE t.NO_REKAP_BCC = '".$No_Rekap."' AND t.NO_BCC = '".$No_BCC."' AND t.ID_RENCANA = '".$oldrencana."'";
										...
										if($result_THP>0){
											if($new_rekap<>$No_Rekap or $new_id_rencana<>$oldrencana){
												...
												$ins_log_hasilpanen = "INSERT INTO T_LOG_HASIL_PANEN
													(INSERTUPDATE, TGL_CREEDIT, NIK_CREEDITOR, LOGIN_NAME_CREEDITOR, ON_TABLE, ON_NO_BCC, ON_KODE_DELIVERY_TICKET, NEW_VALUE_STATUS_BCC, OLD_VALUE_STATUS_BCC, NEW_VALUE_NO_REKAP_BCC, OLD_VALUE_NO_REKAP_BCC, CREEDIT_FROM, SYNC_SERVER, NEW_VALUE_ID_RENCANA, OLD_VALUE_ID_RENCANA, NEW_VALUE_STATUS_TPH, OLD_VALUE_STATUS_TPH)
													VALUES
													('UPDATE', SYSDATE, '$NIK', '$Login_Name', 't_hasil_panen', '".$No_BCC."', 'NULL', 'NULL', 'NULL', '".$new_rekap."', '".$No_Rekap."', 'Website' , SYSDATE, '".$new_id_rencana."', '".$oldrencana1."', '".$newTPH."', '".$old_tph."')";
												$result_ins_log_hasilpanen = oci_parse($con, $ins_log_hasilpanen);
												oci_execute($result_ins_log_hasilpanen, OCI_DEFAULT);
												//echo $ins_log_hasilpanen."<br><br>";
											}
								...
								if($new_id_rencana<>$ID_RENCANA){
									...
									if ($cek_id_rencana_THP == ""){
										if($oldrencana==$new_id_rencana){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_TPH = 'WEBSITE' WHERE NO_REKAP_BCC = '".$no_rekap_bcc_value."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$oldrencana."'";
										$result_THP = num_rows($con, $query_ins_thp);
										if($result_THP>0){
											if($new_rekap<>$no_rekap_bcc_value){
												...
												$ins_log_hasilpanen = "INSERT INTO T_LOG_HASIL_PANEN
													(INSERTUPDATE, TGL_CREEDIT, NIK_CREEDITOR, LOGIN_NAME_CREEDITOR, ON_TABLE, ON_NO_BCC, ON_KODE_DELIVERY_TICKET, NEW_VALUE_STATUS_BCC, OLD_VALUE_STATUS_BCC, NEW_VALUE_NO_REKAP_BCC, OLD_VALUE_NO_REKAP_BCC, CREEDIT_FROM, SYNC_SERVER, NEW_VALUE_ID_RENCANA, OLD_VALUE_ID_RENCANA, NEW_VALUE_STATUS_TPH, OLD_VALUE_STATUS_TPH)
													VALUES
													('UPDATE', SYSDATE, '$NIK', '$Login_Name', 't_hasil_panen', '".$No_BCC."', 'NULL', 'NULL', 'NULL', '".$new_rekap."', '".$no_rekap_bcc_value."', 'Website' , SYSDATE, '".$oldrencana1."', '".$oldrencana1."', '".$newTPH."', '".$old_tph."')";
												$result_ins_log_hasilpanen = oci_parse($con, $ins_log_hasilpanen);
												oci_execute($result_ins_log_hasilpanen, OCI_DEFAULT);
												//echo $ins_log_hasilpanen."<br><br>";
											}
										...
										$query_ins_thp = "INSERT INTO T_HASIL_PANEN
			  (ID_RENCANA, NO_REKAP_BCC, NO_TPH, NO_BCC, KODE_DELIVERY_TICKET, LATITUDE, LONGITUDE, PICTURE_NAME, STATUS_BCC, ID_NAB_TGL, IMAGE_FILE, UPDATE_TIME_CLOB, CETAK_BCC, CETAK_DATE, VALIDASI_BCC, VALIDASI_DATE, STATUS_TPH)
			SELECT '".$new_id_rencana."', t.NO_REKAP_BCC, '".$newTPH."', t.NO_BCC, t.KODE_DELIVERY_TICKET, t.LATITUDE, t.LONGITUDE, t.PICTURE_NAME, t.STATUS_BCC, t.ID_NAB_TGL, t.IMAGE_FILE, t.UPDATE_TIME_CLOB, t.CETAK_BCC, t.CETAK_DATE, t.VALIDASI_BCC, t.VALIDASI_DATE, t.STATUS_TPH
			  FROM T_HASIL_PANEN t
			 WHERE t.NO_REKAP_BCC = '".$No_Rekap."' AND t.NO_BCC = '".$No_BCC."' AND t.ID_RENCANA = '".$oldrencana."'";
										$result_THP = num_rows($con, $query_ins_thp);
