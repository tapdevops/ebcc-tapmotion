			...
			<table width="991" border="0" style="border:solid #556A29;">
				...
				<tr>
					...
					<td width="355" align="left" valign="top" >
						...
						?>
						<select name="AFDlabel" id="AFDlabel" style="width:200px; height:30px; font-size:15px">
							<?php
					...
					<td align="center">
						<?php 
						if ($STATUS_LOKASI <> '1' && $STATUS_TPH == 'MANUAL' && ((int)str_replace('.', '', $jarak) > $TOLERANSI_JARAK)) {?>
				...
				<tr>
					...
					<td width="7" height="29" valign="top" align="right">:</td>
					<td width="355" align="left" valign="top">
						<select name="selectblok" id="selectblok" style="width:200px; height:30px; font-size:15px">
							<?php
				...
				<tr>
					...
					<td width="355" align="left" valign="top">
						...
						<select name="selecttph" id="selecttph" style="width:200px; height:30px; font-size:15px">
				...
				<tr>
					...
					<td width="355" align="left" valign="top" >
						...
						<input name="roweffec_BCC" type="hidden" id="roweffec_BCC" value="<?=$roweffec_BCC?>"/>
						<input name="No_BCC" type="hidden" id="No_BCC" value="<?=$aNO_BCC?>"/>
					</td>
					<td></td>
				</tr>
				<tr>
