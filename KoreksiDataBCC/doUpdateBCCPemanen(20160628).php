...
//echo $NIK_Pemanen."<br>".$tglPanen."<br>".$NIK_Mandor."<br>".$ID_blok."<br>".$No_BCC."<br>".$No_Rekap."<br>".$roweffec_BCC."<br>";die();
	...
	if($NIK_Pemanen == "" || $roweffec_BCC == "" || $No_BCC	== ""){
		...
		for($x=0; $x < $roweffec_BCC; $x++){
			...
			else
			{
				...
				$sql_update_blok = "UPDATE T_DETAIL_RENCANA_PANEN set ID_BA_AFD_BLOK = '" . $ba.$afd.$ID_blok . "' where ID_RENCANA = '" . $ID_RENCANA . "' AND NO_REKAP_BCC = '" . $No_Rekap . "'";
				...
				if($roweffec_value[$x] > 0 && $roweffec_value_log_hasilpanen_kualitas > 0 && $roweffec_value_header_rencana > 0){
					commit($con);
