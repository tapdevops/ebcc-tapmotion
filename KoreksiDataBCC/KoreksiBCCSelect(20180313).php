...
$ID_Group_BA = $_SESSION['ID_Group_BA'];
	...
	if($username == ""){
		...
		if(isset($_POST["editRencanaPanen"])){
		$_SESSION["editRencanaPanen"] = $_POST["editRencanaPanen"];
		}
		
		if(isset($_SESSION["editRencanaPanen"])){
		$editRencanaPanen = $_SESSION["editRencanaPanen"];
		}
        ...
        <td align="center"><table width="995" border="0">
          ...
          <tr>
            ...
            <td width="355" align="left" valign="top" >
				...
				<!-- <input name="AFDlabel" type="text" id="AFDlabel" value="<?=$AFD?>" style="background-color:#CCC; width:300px; height:25px; font-size:15px"/> -->
