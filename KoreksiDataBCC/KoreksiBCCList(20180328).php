...
echo "<td width=\"44px\" align=\"center\" style=\"font-size:12px; visibility:hidden\" >$no</td>
...
for($xBCC = 0; $xBCC <  $roweffec_BCC; $xBCC++){
	...
	if($POST_STATUS[$xBCC]=='X' or $EXPORT_STATUS[$xBCC]=='X'){
		...
		$btn = "<a href=\"javascript:;\" onclick=\"javascript: document.getElementById('formNOBCC$xBCC') .submit()\">
				<input type=\"button\" name=\"button\" id=\"button\" value=\"Koreksi\" style=\"width:90px; height:25px; font-size:14px\"/>
				$EXPORT_STATUS[$xBCC]</a>";
	}
	
echo "<tr style=\"font-size:12px;\" bgcolor=$bg>";
echo "<td width=\"44px\" align=\"center\" style=\"font-size:12px\" id=\"bordertable\">$no</td>
