		...
		<td height="45" colspan="3" valign="bottom" style="border-bottom:solid #000">PERIODE</td>
          ...
          <form id="form3" name="form3" method="post" action="doFilter.php">
                  ...
                  <tr>
					...
					<tr>
                    <td width="70" height="29" valign="top" >Pencarian Berdasarkan</td>
					<td width="10" height="29" valign="top" >:</td>
					<td width="100" align="left" valign="top" >
					<select  name="selectfinder" id="selectfinder" style="font-size: 15px">
                ...
                <!--Mandor--><input type="radio" name="group" id="group" value="Pemanen" onclick="change(3)" style="display:none"/><!--Pemanen-->
          </form>
		</th>
  </tr>
