      ...
      <tr>
        <td align="center"><table width="995" border="0">
          <tr>
            ...
            <td width="7" height="29" valign="top">:</td>
            <td width="355" align="left" valign="top"><input name="TanggalLabel" type="text" id="TanggalLabel" value="<?=$TANGGAL_RENCANA?>" style="background-color:#CCC; width:300px; height:25px; font-size:15px" onmousedown="return false"/></td>
            </tr>
          <tr>
            ...
            <td width="7" height="29" valign="top" >:</td>
            <td width="355" align="left" valign="top" ><input name="Nama_Mandorlabel" type="text" id="Nama_Mandorlabel" value="<?=$NAMA_MANDOR?>" style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/></td>
            </tr>
          <tr>
            ...
            <td width="7" height="29" valign="top" >:</td>
            <td width="355" align="left" valign="top" ><input name="No_BCClabel" type="text" id="No_BCClabel" value="<?=separator($aNO_BCC)?>" style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/></td>
            </tr>
        </table></td>
        </tr>
      <tr>
        <td align="center">
          <table width="991" border="0" style="border:solid #556A29">
            ...
            <tr>
              ...
              <td width="7" height="29" valign="top" >:</td>
              <td width="355" align="left" valign="top" >
                <input name="NIK_Pemanen" type="text" id="NIK_Pemanen" value="<?=$NIK_Pemanen?>" style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/>              </td>
              </tr>
          </table>        </td>
        </tr>
      <tr>
        <td align="center"><form id="FormEditBCC" name="FormEditBCC" method="post" action="doUpdateBCCPemanen.php">
...
echo "<td>$no</td>
			...
			<input type=\"text\" name=\"NIK_Pemanen\" value=\"$NIK_Pemanen\" style=\"display:none\">
