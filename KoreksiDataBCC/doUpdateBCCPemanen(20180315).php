							...
							if($ID_BA_tdrp!=$id_bafd) {
								...
								if ($cek_id_rencana_THP == "") {
									if($plan_ID==$ID_RENCANA) {
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_TPH = 'WEBSITE', STATUS_DETIC = 'WEBSITE', STATUS_LOKASI = '1' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$ID_RENCANA."'";
								...
								if ($cek_id_rencana_THP == ""){
									if($plan_ID==$ID_RENCANA){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$no_rekap_bcc_value."', NO_TPH = '".$newTPH."', STATUS_TPH = 'WEBSITE', STATUS_LOKASI = '1' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$ID_RENCANA."'";
										$result_THP = num_rows($con, $query_ins_thp);
							...
							if($ID_BA_tdrp!=$id_bafd){
								...
								if ($cek_id_rencana_THP == ""){
									...
									if($oldrencana==$new_id_rencana){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_TPH = 'WEBSITE', STATUS_LOKASI = '1' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$oldrencana."'";
										$result_THP = num_rows($con, $query_ins_thp);
										if($result_THP>0){
											//Added by Ardo, 22-2-2016 : Insert into t_log_hasilpanen
											$ins_log_hasilpanen = "INSERT INTO T_LOG_HASIL_PANEN
			...
			SELECT '".$new_id_rencana."', '".$new_rekap."', '".$newTPH."', t.NO_BCC, t.KODE_DELIVERY_TICKET, t.LATITUDE, t.LONGITUDE, t.PICTURE_NAME, t.STATUS_BCC, t.ID_NAB_TGL, t.IMAGE_FILE, t.UPDATE_TIME_CLOB, t.CETAK_BCC, t.CETAK_DATE, t.VALIDASI_BCC, t.VALIDASI_DATE, t.STATUS_TPH, t.STATUS_DETIC, t.STATUS_LOKASI
			 ...
			 WHERE t.NO_REKAP_BCC = '".$No_Rekap."' AND t.NO_BCC = '".$No_BCC."' AND t.ID_RENCANA = '".$oldrencana."'";
								...
								if($new_id_rencana<>$ID_RENCANA){
									...
									if ($cek_id_rencana_THP == ""){
										if($oldrencana==$new_id_rencana){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_TPH = 'WEBSITE', STATUS_LOKASI = '1' WHERE NO_REKAP_BCC = '".$no_rekap_bcc_value."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$oldrencana."'";
										$result_THP = num_rows($con, $query_ins_thp);
										if($result_THP>0){
