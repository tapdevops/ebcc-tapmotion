...
logToFile('Koreksi BCC STEP 8 : '.$query_thp_cek);
								if ($cek_id_rencana_THP == "") {
									if($plan_ID==$ID_RENCANA) {
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_DETIC = 'WEBSITE', STATUS_LOKASI = '1' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$ID_RENCANA."'";
...
logToFile('Koreksi BCC STEP 18 : '.$query_thp_cek);
								...
								if ($cek_id_rencana_THP == ""){
									if($plan_ID==$ID_RENCANA){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$no_rekap_bcc_value."', NO_TPH = '".$newTPH."', STATUS_LOKASI = '1' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$ID_RENCANA."'";
										$result_THP = num_rows($con, $query_ins_thp);
...
logToFile('Koreksi BCC STEP 45 : '.$query_thp_cek);
								...
								if ($cek_id_rencana_THP == ""){
									...
									if($oldrencana==$new_id_rencana){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_LOKASI = '1' WHERE NO_REKAP_BCC = '".$No_Rekap."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$oldrencana."'";
										$result_THP = num_rows($con, $query_ins_thp);
...
logToFile('roweffec_change_data 8');
								...
								if($new_id_rencana<>$ID_RENCANA){
									...
									if ($cek_id_rencana_THP == ""){
										if($oldrencana==$new_id_rencana){
										$query_ins_thp = "UPDATE T_HASIL_PANEN SET NO_REKAP_BCC = '".$new_rekap."', NO_TPH = '".$newTPH."', STATUS_LOKASI = '1' WHERE NO_REKAP_BCC = '".$no_rekap_bcc_value."' AND NO_BCC = '".$No_BCC."' AND ID_RENCANA = '".$oldrencana."'";
										$result_THP = num_rows($con, $query_ins_thp);
...
logToFile('Total Jumlah Insert : ' . json_encode($roweffec_value));
