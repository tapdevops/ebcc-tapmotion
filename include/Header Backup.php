    ...
    <ul>
		...
		if($initial == true){
				...
				for($x =0; $x<$roweffec_jenis_login; $x++)
				{
					...
					if($Jenis_Login[$x] == 4 || $Jenis_Login[$x] == 6 || $Jenis_Login[$x] == 0)
					{
						$x_found = true;
					}
				}
				...
				for($x =0; $x<$roweffec_jenis_login; $x++)
				{
					...
					if($Jenis_Login[$x] == 4 || $Jenis_Login[$x] == 6 || $Jenis_Login[$x] == 8 || $Jenis_Login[$x] == 0)
					{
						$x_found = true;
						//if($Jenis_Login[$x] == 4 || $Jenis_Login[$x] == 5 || $Jenis_Login[$x] == 0)
						...
						if($Jenis_Login[$x] == 6 || $Jenis_Login[$x] == 8 || $Jenis_Login[$x] == 0)
						{
							$x_found_2 = true;
						}
						//if($Jenis_Login[$x] == 4 || $Jenis_Login[$x] == 5 || $Jenis_Login[$x] == 0)
				...
				for($x =0; $x<$roweffec_jenis_login; $x++)
				{
					if($Jenis_Login[$x] == 4 || $Jenis_Login[$x] == 5 || $Jenis_Login[$x] == 6 || $Jenis_Login[$x] == 8 || $Jenis_Login[$x] == 0)
					{
						$x_found = true;
						//if($Jenis_Login[$x] == 4 || $Jenis_Login[$x] == 5 || $Jenis_Login[$x] == 6 || $Jenis_Login[$x] == 8 || $Jenis_Login[$x] == 0)
						if($Jenis_Login[$x] == 4 || $Jenis_Login[$x] == 5 || $Jenis_Login[$x] == 6 || $Jenis_Login[$x] == 0)
						{
							$x_found_1 = true;
						}
						//if($Jenis_Login[$x] == 4 || $Jenis_Login[$x] == 5 || $Jenis_Login[$x] == 6 || $Jenis_Login[$x] == 8 || $Jenis_Login[$x] == 0)
