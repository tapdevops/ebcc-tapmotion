					...
					//echo "<li><a href=\"#\">Koreksi Data</a><ul>";
						if($x_found_1 == true){
							echo "<form id=\"formInputHasilPanen\" name=\"formInputHasilPanen\" 
								...
								value=\"TRUE\" style=\"display:none\" onmousedown=\"return false\"/>
								<li><a href=\"javascript:;\" onclick=\"javascript: document.getElementById('formInputHasilPanen').submit()\">Input Hasil Panen
								</a></li>
								</form>";	
							//echo "<li><a href=\"../include/ResetSession.php?link=KorBCC\">BCC</a></li>";
						}
						...
						if($x_found_2 == true){
							echo "<form id=\"formInputPengiriman\" name=\"formInputPengiriman\" 
								...
								value=\"TRUE\" style=\"display:none\" onmousedown=\"return false\"/>
								<li><a href=\"javascript:;\" onclick=\"javascript: document.getElementById('formInputPengiriman').submit()\">Input Pengiriman Panen
								</a></li>
								</form>";	
							//echo "<li><a href=\"../include/ResetSession.php?link=KorNAB\">NAB</a></li>";
						}
						...
						if($x_found_3 == true){
							echo "<form id=\"formInputAktivitas\" name=\"formInputAktivitas\" 
								...
								value=\"TRUE\" style=\"display:none\" onmousedown=\"return false\"/>
								<li><a href=\"javascript:;\" onclick=\"javascript: document.getElementById('formInputAktivitas') .submit()\">Input Aktivitas
								</a></li>
								</form>";	
							//echo "<li><a href=\"../include/ResetSession.php?link=KorNAB\">NAB</a></li>";
						}
					...
					//echo "<li><a href=\"#\">Administration</a><ul>";
						...
						if($x_found_6 == true){
							echo "<form id=\"formSetIP\" name=\"formSetIP\" 
								...
								value=\"TRUE\" style=\"display:none\" onmousedown=\"return false\"/>
								<li><a href=\"javascript:;\" onclick=\"javascript: document.getElementById('formSetIP') .submit()\">Setting IP
								</a></li>
								</form>";
						...
						if($x_found_7 == true){
							echo "<form id=\"formInputUser\" name=\"formInputUser\" 
								...
								value=\"TRUE\" style=\"display:none\" onmousedown=\"return false\"/>
								<li><a href=\"javascript:;\" onclick=\"javascript: document.getElementById('formInputUser') .submit()\">Input User
								</a></li>
								</form>";
