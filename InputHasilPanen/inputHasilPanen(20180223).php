...
function onChangeValue(iter, obj){
	...
	jmlh = eval(document.getElementById('mentah'+iter).value) + eval(document.getElementById('mengkal'+iter).value) + 
		   ...
		   eval(document.getElementById('busuk'+iter).value) + eval(document.getElementById('jangkos'+iter).value) + 
...
cell4.appendChild(el);
	...
	el.onblur = function() {
				...
				jmlh = eval(document.getElementById('mentah'+iteration).value) + eval(document.getElementById('mengkal'+iteration).value) + 
					   eval(document.getElementById('masak'+iteration).value) + eval(document.getElementById('toomasak'+iteration).value) +
					   eval(document.getElementById('busuk'+iteration).value) + eval(document.getElementById('jangkos'+iteration).value);
				document.getElementById('janjang'+iteration).value = jmlh;
            }
