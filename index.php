...
<table width="901" height="725" border="0" align="center"> <!--table besar-->
  ...
  <tr style="background:url(image/greenBack.png) no-repeat;background-position:center;">
    <th height="148" scope="row"><form id="frmlog" name="formlogin" action="alogin.php" method="post">
          <table width="297" height="144" border="0" align="center">
            <!--table login-->
            <tr>
              <th width="100" align="left" scope="row">Login Name</th>
              <td><input name="LoginName" type="text" id="LoginName" /></td>
            </tr>
            <tr>
              <th width="100" align="left" scope="row">Username</th>
              <td width="187"><input name="Usrname" type="text" /></td>
            </tr>
            <tr>
            ...
            <tr>
              <th colspan="2" align="center" valign="middle" scope="row"><input name="lgin" type="submit" value="Login" /></th>
            </tr>
            <tr>
  ...
  <tr style="background:url(image/footer.png) no-repeat; background-position:center; margin-top: -2px">
    <th height="30" scope="row" style="font-size:12px" align="center">  Copyright 2014 - PT. TRIPUTRA AGRO PERSADA <br> version-2.0.0</th>
  </tr>
