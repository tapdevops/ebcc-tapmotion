    ...
    <th height="100" scope="row" align="center">
          <form id="doFilter" name="doFilter" method="post" action="doFilter.php">
            <table border="0" id="setbody2">
              ...
              <tr>
                <td height="50" colspan="4" valign="baseline"><span style="font:bold; font-size:20px; font-weight: bold;"><strong>SAP TEMPLATE DENDA PANEN</strong></span></td>
                <td height="50" colspan="3" align="right" valign="baseline">
                <input type="submit" name="button" id="button" value="DOWNLOAD" style="width:120px; height: 30px"/>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <td width="161">Company Name</td>
                <td width="9">:</td>
                <td width="371"><input name="Comp_Name" type="text" id="Comp_Name" value="<?=$Comp_Name?>" style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/></td>
                <td width="7">&nbsp;</td>
                <td width="89"><span>Start Date</span></td>
                <td width="10">:</td>
                <td width="295">
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td width="89"><span>End Date</span></td>
                <td width="10">:</td>
                <td width="295">
