...
$(document).ready(function(){
  ...
  $("#afdeling").change(function(){
   ...
   var tgl_kirim = $("#datepicker").val();
    ...
    $.ajax({
        url: "getData.php",
        data: "afdeling="+afdeling + "&var_tgl=" + tgl_kirim,
        method: 'POST',
		cache: false,
...
function validateInput(){
	...
	if(total == 0){
		alert("Pilih data yang akan disimpan terlebih dahulu!");
		return false;
	}
	return returnValue;
}
	...
	<tr>
	  ...
	  <tr>
		  ...
		  <tr>
			...
			<td width="10" height="29" valign="top">:</td>
			<td width="100" valign="top"><input type="text" name="NoNAB" id="NoNAB" maxlength="7" onkeypress='return isNumber(event)' onchange='cekUpper()' onblur='cekData()'><span class="f_alertRed10px" id="alert_NAB"></span></td>
		  </tr>
		   <tr>
