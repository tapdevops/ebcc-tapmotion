...
$ID_Group_BA 	= $_SESSION['ID_Group_BA'];
	...
	if($username == ""){
		...
		$sql_t_BCC = "SELECT
		   ...
		   THP.LATITUDE,  
		   THP.PICTURE_NAME,
		   nvl('-',THP.INPUT_TIME) as input_time,
		...
		while(oci_fetch($result_t_BCC)){
			...
			$INPUT_TIME 			= oci_result($result_t_BCC, "INPUT_TIME");
          ...
          <td align="center">
            <table width=100% >  
               ...
               <tr>
				...
				<td width="228" valign="top">Waktu Input</td>
                <td width="378" valign="top"><?=$INPUT_TIME?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td rowspan="6" valign="top"><img src="../array/uploads/<?=$PICTURE_NAME?>" width="275" height="200" alt="<?=$PICTURE_NAME?>" align="absmiddle" ></td>
              </tr>
              <tr>
                <td>Afdeling</td>
                <td><?=$AFD?></td>
