...
$ID_Group_BA 	= $_SESSION['ID_Group_BA'];
	...
	if($username == ""){
		...
		$sql_t_BCC = "SELECT
		   ...
		   F_GET_IDBA_IDR (TDRP.ID_RENCANA,TDRP.ID_BA_AFD_BLOK) AS BA,
          ...
          <td align="center">
            <table width=100% >  
               ...
               <tr>
                ...
                <td width="378" valign="top"><?=$TANGGAL?></td>
              </tr>
              <tr>
                <td colspan="4" bgcolor="#9CC346">Lokasi Panen</td>
              </tr>
              <tr>
                <td width="117" valign="top">Business Area</td>
                <td width="373" valign="top"><?=$BA?></td>
              ...
              <tr>
                <td colspan="4" bgcolor="#9CC346">Mandor</td>
              </tr>
              <tr>
                <td width="117" valign="top">Business Area</td>
                <td width="373" valign="top"><?=$IDBA_MANDOR?></td>
                <td width="128" valign="top">Nama Mandor</td>
                <td width="378" valign="top"><?=$NAMA_MANDOR?>                </td>
              </tr>
              <tr>
                <td>Afdeling</td>
                <td><?=$IDAFD_MANDOR?></td>
              ...
              <tr>
                <td colspan="4" bgcolor="#9CC346">Pemanen</td>
              </tr>
              <tr>
                <td width="117" valign="top">Business Area</td>
                <td width="373" valign="top"><?=$IDBA_PEMANEN?></td>
                <td width="128" valign="top">Nama Pemanen</td>
                <td width="378" valign="top"><?=$NAMA_PEMANEN?>                </td>
              </tr>
              <tr>
                <td>Afdeling</td>
                <td><?=$IDAFD_PEMANEN?></td>
