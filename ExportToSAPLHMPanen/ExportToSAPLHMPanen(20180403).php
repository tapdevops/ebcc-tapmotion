      ...
      <div class="fixed-table-container-inner">
        <table cellspacing="0" class="scroll">
				...
				for ($counter = 0; $counter < $roweffec; $counter++){
					...
					if (($bcc_export[$counter]['JARAK'] <= $bcc_export[$counter]['TOLERANSI_JARAK']) || $bcc_export[$counter]['STATUS_LOKASI'] == '0') {
						$valid_latlong++;
					}
		...
		<div style="width:1100px">	
			...
			<td height="50" colspan="9" align="right" valign="baseline"><input type="submit" name="btn_export" id="btn_export" value="EXPORT" style="width:120px; height: 30px" <?php if($jml_valid<1 or $valid_cetak>0 or $valid_latlong > 0){ echo "disabled"; } ?> /></td>
			</form>
		</div>
