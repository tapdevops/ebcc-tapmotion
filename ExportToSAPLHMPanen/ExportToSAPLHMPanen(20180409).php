      ...
      <div class="fixed-table-container-inner">
        <table cellspacing="0" class="scroll">
				...
				for ($counter = 0; $counter < $roweffec; $counter++){
					...
					if (!empty($bcc_export[$counter]['STATUS_TPH']) && !empty($bcc_export[$counter]['STATUS_DETIC'])) {
						//echo 'zzz';
						if (($bcc_export[$counter]['JARAK'] <= $bcc_export[$counter]['TOLERANSI_JARAK']) || $bcc_export[$counter]['STATUS_LOKASI'] == '0' || empty($bcc_export[$counter]['STATUS_LOKASI']) || $bcc_export[$counter]['STATUS_LOKASI'] === NULL) {
							$valid_latlong++;
						}
					}
