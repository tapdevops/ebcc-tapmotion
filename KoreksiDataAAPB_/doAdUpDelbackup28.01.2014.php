...
if(isset($_POST['UpdateAAP']) || isset($_POST['AddAAP']) || isset($_POST['NewAAPSubmit']) || isset($_POST['DelStat'])){
	...
	if($_POST['UpdateAAP'] == "" && $_POST['AddAAP'] == "" && $_POST['NewAAPSubmit'] == "" && $_POST['DelStat'] == ""){
		...
		if($_POST['UpdateAAP'] == TRUE){
			...
			//OPEN ADIT UPDATE
			if(isset($_POST['NO_REKAP_BCC']) && isset($_POST['roweffec_DETAILGANDENG']) && isset($_POST['Luasan_Panen']) && isset($_POST['ID_RENCANA']) && isset($_SESSION['ID_Group_BA']) ){
		...
		// OPEN TASYA ADD and SUBMIT
			...
			if(isset($_POST['ID_Detail_Gandeng_BARU']) && isset($_POST['ID_Rencana_IGBARU']) && isset($_POST['NIK_Gandeng_BARU']) && isset($_POST['ID_BA_Gandeng']) && isset($_SESSION['LoginName']) && isset($_SESSION['NIK']) && isset($_SESSION['ID_Group_BA']) ){
		...
		// OPEN TASYA DELETE
			...
			if($totalRow == 1)
			{
				$sql_DeleteIDGandeng = "UPDATE t_detail_gandeng SET NIK_GANDENG = '-' WHERE ID_GANDENG='$DelAAP_ID' and ID_RENCANA = '$Del_IDRencana'";
