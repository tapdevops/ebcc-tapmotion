...
<table width="85%" style="margin-top:30px;">
	...
	<tr>
		<td><strong style="color:green;">Generate QR Code Success <br />Lokasi QR Code : <a href="file:/\/\/fs.tap-agri.com\QRqa">\\fs.tap-agri.com\QRqa</a></strong></td>
	</tr>
	...
	<tr>
		<td style="padding-top:20px;">
			<font color="green"><i>QR Code TPH Berhasil Digenerate. <br />Lokasi QR Code : <a href="file://///10.20.1.7/QRqa">\\10.20.1.7</a></i></font>
		</td>
	</tr>
	<?php endif; ?>
	<tr>
			...
			<table style="margin-top:20px; width:45%; border:1px solid black;">
				<thead>
					<tr style="text-align:left;">
						...
						<th style="width:30%;margin:10px; padding:10px; border-bottom:1px solid black;">Jumlah TPH</th>
						<th style="border-bottom:1px solid black;">TPH Baru</th>
					</tr>
				</thead>
				<tbody id="blok">
				</tbody>
	...
	<tr>
		<td>
			<input type="submit" name="submit" value="GENERATE" style="font-weight:bold; font-size:15px;">
			<input type="submit" name="submit" value="REGENERATE" style="font-weight:bold; font-size:15px;">
		</td>
	</tr>
	<tr>
