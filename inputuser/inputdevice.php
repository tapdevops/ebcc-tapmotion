...
<table width="1151" height="390" border="0" align="center">
  ...
  <tr>
    <th height="197" scope="row" align="center"><table width="937" border="0" id="setbody2">
      <tr>
		<td colspan="3" align="left" valign="baseline"><span style="font:bold; font-size:20px; font-weight: bold;"><strong>REGISTER NEW USER</strong></span></td>
      </tr>
        <tr valign="middle">
              ...
              <tr>
				...
				<form id="form1" name="form1" method="post" action="doSubmit.php" onsubmit="return validasi_input(this)">
                    <table width="1104"  border="0" style="border:#9CC346 ridge">
                      ...
                      <tr>
                        <td width="12%" height="29" valign="top">BA/NIK</td>
						<td width="25%"><input type="text" name="NIK"></td>
                        <td width="150" height="29" valign="top">NAMA USER</td>
						<td><input type="text" name="USER"></td>						
                      </tr>
					 <tr>
						<td width="150" height="29" valign="top">Authority</td>
						<td><select name="jabatan" id="jabatan">
							<option select="selected">--select--</option>
								<?php
									$sql_t_BA  = "SELECT AUTHORITY, AUTHORITY_NAME FROM T_AUTHORITY WHERE AUTHORITY IN (5, 6, 8, 10)";
									$result_t_BA = oci_parse($con, $sql_t_BA);
												   oci_execute($result_t_BA, OCI_DEFAULT);
									while ($p=oci_fetch($result_t_BA)) {	
												  $id_kabkot = oci_result($result_t_BA, "AUTHORITY");
												  $nama_kabkot = oci_result($result_t_BA, "AUTHORITY_NAME");
									     		  echo "<option value=\"$id_kabkot\">$id_kabkot - $nama_kabkot</option>\n";
									}
								?>
						</td>	
				...
				<form id="form1" name="form1" method="post" action="doSubmit.php" onsubmit="return validasi_input(this)">
                    <table width="1104"  border="0" style="border:#9CC346 ridge">
                     ...
                     <tr>
						...
						<td><input name="propinsi" type="text" size="50" class="box" value="<?=$subID_CC?>" readonly="readonly"/></td>
                      </tr>
                      <tr>
                        <td width="150" height="29" valign="top">Business Area</td>
						<td width="10" height="29" valign="top">:</td>
						<td><input name="kota" type="text" size="50" class="box" value="<?=$subID_BA_Afd?>" readonly="readonly"/></td>
                      </tr>
						...
						<option selected="selected">--select--</option>
                            <?php
									$sql_t_BA  = "select te.nik, te.emp_name from t_employee te inner join 
               									  t_afdeling ta on te.id_ba_afd = ta.id_ba_afd where ID_BA='$subID_BA_Afd' and job_code='KRANI BUAH' order by te.emp_name ";
									$result_t_BA = oci_parse($con, $sql_t_BA);
												   oci_execute($result_t_BA, OCI_DEFAULT);
									while ($p=oci_fetch($result_t_BA)) {
                      ...
                      <tr>
                        <td width="150" height="29" valign="top">Merk</td>
						<td width="10" height="29" valign="top">:</td>
						<td><input name="merk" type="text" size="50" class="box" /></td>
                      </tr>
                      <tr>
                        <td width="150" height="29" valign="top">Type</td>
						<td width="10" height="29" valign="top">:</td>
						<td><input name="tipe" type="text" size="50" class="box" /></td>
                      </tr>
                      <tr>
                        <td width="150" height="29" valign="top">No. IMEI</td>
						<td width="10" height="29" valign="top">:</td>
