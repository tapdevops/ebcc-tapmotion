...
<table width="1064" height="390" border="0" align="center">
  ...
  <tr bgcolor="#C4D59E">
    <th align="center" valign="top" scope="row"><table width="1044" border="0">
      <tr>
        <td colspan="5"><span style="font-size:18px">Register Device</span></td>
...
<input name="EditBA" type="text" id="EditBA" value="<?=$vID_BA?>" style="background-color:#CCC; width: 70px; height:25px; font-size:15px; display:<?= $vdisBA?>" onmousedown="return false"/>
      ...
      <tr>
        <td height="14" valign="top" style="font-size:14px">Merk</td>
        <td height="14" valign="top" style="font-size:14px">:</td>
        <td height="14" colspan="3" valign="top" style="font-size:14px"><input name="merk" type="text" size="50" class="box" />   </td>
        <td height="14" valign="bottom" style="font-size:14px">&nbsp;</td>
        <td height="14" colspan="3" valign="bottom" style="font-size:14px">&nbsp;</td>
      </tr>
      <tr>
        <td height="15" valign="top" style="font-size:14px">Type</td>
        <td height="15" valign="top" style="font-size:14px">:</td>
        <td height="15" colspan="3" valign="top" style="font-size:14px"><input name="tipe" type="text" size="50" class="box" /> </td>
        <td height="14" valign="bottom" style="font-size:14px">&nbsp;</td>
        <td height="14" colspan="3" valign="bottom" style="font-size:14px">&nbsp;</td>
      </tr>
        ...
        <tr>
        <td height="15" valign="top" style="font-size:14px">No Imei</td>
        <td height="15" valign="top" style="font-size:14px">:</td>
        <td height="15" colspan="3" valign="top" style="font-size:14px"><input name="imei" type="text" class="box" id="imei" size="50" /> </td>
        <td height="14" valign="bottom" style="font-size:14px">&nbsp;</td>
        <td height="14" colspan="3" valign="bottom" style="font-size:14px">&nbsp;</td>
      </tr>
      
          <tr>
        <td height="14" valign="top" style="font-size:14px">Nik User 1</td>
        <td height="14" valign="top" style="font-size:14px">:</td>
        <td height="14" colspan="3" valign="top" style="font-size:14px"><input name="Nama_TM1" type="text" id="Nama_TM1" value="<?=$Nama_TM1?>" size="50" class="box"  onchange="send(1)"/>
                          <script type="text/javascript">
        ...
        <td height="14" colspan="4" valign="top" style="font-size:14px"><input name="NIK_TM1" type="text" id="NIK_TM1" value="<?=$NIK_TM1?>" style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/></td>
    
      </tr>
      <tr>
        <td height="15" valign="top" style="font-size:14px">Nik User 2</td>
        <td height="15" valign="top" style="font-size:14px">:</td>
        <td height="15" colspan="3" valign="top" style="font-size:14px"><input name="Nama_TM2" type="text" id="Nama_TM2" value="<?=$Nama_TM2?>" size="50" class="box"  onchange="send(2)"/>
                          <script type="text/javascript">
					$(document).ready(function() {
						//var bacode = $("#BATM1").val();
						var bacode = "<?php echo $subID_BA_Afd; ?>";
        ...
        <td height="14" colspan="4" valign="top" style="font-size:14px"><input name="NIK_TM2" type="text" id="NIK_TM2" value="<?=$NIK_TM2?>" style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/></td>
      </tr>
...
echo "
		<table width=\"1140\" border=\"1\" bordercolor=\"#9CC346\">
          <tr bgcolor=\"#9CC346\">
            <td width=\"50\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">BA</td>
			<td width=\"60\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">TANGGAL RENCANA</td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">BLOK</td>
            <td width=\"120\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">NO REKAP BCC</td>
            <td width=\"100\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">NIK PEMANEN</td>
			<td width=\"100\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">NAMA PEMANEN</td>
			<td width=\"100\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">NIK KRANI BUAH</td>
			<td width=\"100\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">NAMA KRANI BUAH</td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px; border-bottom:ridge\">IMEI</td>
          </tr>
";
...
echo "<td align=\"center\">&nbsp;$BA1[$xJAN]</td>
            <td align=\"center\">&nbsp;$TANGGAL_RENCANA1[$xJAN]</td>
            <td align=\"center\">&nbsp;$BLOK1[$xJAN]</td>
			<td align=\"center\">&nbsp;$fixedBCC2</td>
			<td align=\"center\">&nbsp;$NIK_PEMANEN1[$xJAN]</td>
			<td align=\"center\">&nbsp;$PEMANEN1[$xJAN]</td>
			<td align=\"center\">&nbsp;$NIK_KERANI_BUAH1[$xJAN]</td>
			<td align=\"center\">&nbsp;$KRANI[$xJAN]</td>
			<td align=\"center\">&nbsp;$IMEI1[$xJAN]</td>
