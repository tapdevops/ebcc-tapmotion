		...
		<td height="45" colspan="3" valign="bottom" style="border-bottom:solid #000">PERIODE</td>
          ...
          <form id="form3" name="form3" method="post" action="doFilter.php">
                  ...
                  <tr>
					...
					<tr>
						<td width="70" height="29" valign="top" >Status BCC</td>
						<td width="10" height="29" valign="top" >:</td>
						<td width="100" align="left" valign="top" >
							<select name="status_export" id="status_export" style="visibility:visible; font-size: 15px">
								<option value="ALL">ALL</option>
								<option value="Belum Cetak">Belum Cetak</option>
								<option value="Tercetak">Tercetak</option>
								<option value="Sudah Export">Sudah Export</option>
								<option value="Sudah Post">Sudah Post</option>
							</select>
						</td>
					</tr>
              <tr>
			  ...
			  <tr>
				<td width="100" height="29" valign="top" >Pencarian Berdasarkan</td>
				<td width="10" height="29" valign="top" >:</td>
				<td width="100" align="left" valign="top" ><select  name="selectfinder" id="selectfinder" style="font-size: 15px">

				  <option value="PEMANEN">Pemanen</option>
				  <option value="MANDOR">Mandor</option>
				  <option value="NO_BCC">No BCC</option>
				</select>
				  <input name="typefinder" type="text" id="typefinder" value="" style="width: 200px; font-size:15px"/></td>
			  ...
			  <tr>
                <td>
					<input type="radio" name="group" id="group" value="Mandor" onclick="change(2)" style="display:none"/>
					<input type="radio" name="group" id="group" value="Pemanen" onclick="change(3)" style="display:none"/>
				</td>
              </tr>
          </form>
    </table></th>
