...
function validateInput(elem){
	...
	if (document.getElementById("txtNik").value != "" && document.getElementById("nikMandor").value != "" && document.getElementById("nikPemanen").value != ""
	&& document.getElementById("datepicker").value != ""){	
		messageArea = document.getElementById("alert_txtNIK");
		messageArea.innerHTML = '';
		messageArea = document.getElementById("alert_txtMandor");
	...
	for (i = 1; i <= jmlrow; i++){
		...
		if(v_janjang == '0'){
			alert("Jumlah janjang tidak boleh 0!");
			return false;
		}
			...
			<legend>HASIL PANEN</legend>
				<table id="hasil_panen" border="0" cellpadding="1" cellspacing="1" style="table-layout:fixed; overflow-x:scroll">
					<tr #04B431>
						...
						<th class="f_alert13px">JUMLAH</br>JANJANG</th>
					...
					<tr>
						...
						<td>
							<select name="blok1" id="blok1" onblur='cekData()'>
							<option value='0' selected="selected">--select--</option>
							<?php
						...
						<td><input style="width:34px;" maxlength="3" type='text' name='tph1' id='tph1' value='' onkeypress="return isNumber(event)"></td>
						...
						<td><input style="width:58px;" type='text' name='busuk1' id='busuk1' value='0' onblur='changeformat(this)'></td>
						<td><input style="width:58px;" type='text' name='jangkos1' id='jangkos1' value='0' onblur='changeformat(this)'></td>
...
function addRowToTable() {
	...
	el.onblur = function() {
				...
				jmlh = eval(document.getElementById('mentah'+iteration).value) + eval(document.getElementById('mengkal'+iteration).value) + 
					   eval(document.getElementById('masak'+iteration).value) + eval(document.getElementById('toomasak'+iteration).value);
