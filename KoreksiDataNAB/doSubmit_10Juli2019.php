...
//echo $supir . " - " . $TM1 . " - " . $TM2 . " - " . $TM3 . " - " . $ID_NAB_TGL . " - " . $NIK . " - " . $Login_Name . " - " . $No_Polisi . " - ID IO : " . $Id_Internal_Order
...
if($tmp_dateNAB >= $tmp_date){
		...
		if($roweffec_select > 0 && $startInputBcc == $countRow){
			...
			$a = 1;
				...
				//echo "internal".$Id_Internal_Order."<br>";die();
				if(($Id_Internal_Order == "" || $Id_Internal_Order == NULL) && $TIPE_ORDER == 'INTERNAL'){
					$a = 2;
					...
					if($roweffec_cek_supir == 0 && $TIPE_ORDER == 'INTERNAL')
					{
						$a = 4;
					...
					else
					{
						...
						if($id_IO == ''){
							$id_IO = '-';
						}//echo $No_NAB . " - " . $tglNAB . " - " . $supir . " - " . $TM1 . " - " . $TM2 . " - " . $TM3 . " - " . $No_Polisi 
						//	. " - " . $Id_Internal_Order . " - " . $TIPE_ORDER . " - " . $ID_NAB_TGL . " ; "; die();
