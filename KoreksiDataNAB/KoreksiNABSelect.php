...
$(document).ready(function(){
	...
	document.getElementById('tmp_NIK_TM1').value=document.getElementById('NIK_TM1').value;
	document.getElementById('tmp_NIK_TM2').value=document.getElementById('NIK_TM2').value;
	document.getElementById('tmp_NIK_TM3').value=document.getElementById('NIK_TM3').value;
	
	document.getElementById('tmp_Nama_TM1').value=document.getElementById('Nama_TM1').value;
	document.getElementById('tmp_Nama_TM2').value=document.getElementById('Nama_TM2').value;
	document.getElementById('tmp_Nama_TM3').value=document.getElementById('Nama_TM3').value;		
	...
	$("#btn_simpan").click( function(){
		if (validateInput() == false){
			...
			if(tipeOrder == 'INTERNAL'){
				...
				var noPolisi = document.getElementById('No_PolisiLabel2').value;
				var namaSupir = document.getElementById('Nama_Supir2').value;
				var nikSupir = document.getElementById('NIK_Supir1').value;
				if(noPolisi == '' || namaSupir == '' || nikSupir == ''){
					if(noPolisi == '' || noPolisi == '-'){
						messageArea = document.getElementById("alert_txtNoPolisi");
					...
					if(namaSupir == ''){
						messageArea = document.getElementById("alert_txtNamaSupir");
						messageArea.innerHTML = '*Supir harus diisi!';
						return false;
					}else{
						messageArea = document.getElementById("alert_txtNamaSupir");
						messageArea.innerHTML = '';
...
function push_data(){
	...
	if(tipeOrder == 'INTERNAL'){
		...
		document.getElementById('sNO_POLISI').value = document.getElementById('No_PolisiLabel2').value;
		document.getElementById('sID_INTERNAL_ORDER1').value = '-';
		document.getElementById('s_Supir').value = document.getElementById('Nama_Supir2').value;
		document.getElementById('s_TM1').value  = '-';
		document.getElementById('s_TM2').value  = '-';
		document.getElementById('s_TM3').value  = '-';
...
function check() {
	...
	*/
	...
	if(str == "INTERNAL") {
        show_internal();
		hide_eksternal();
		if(document.getElementById('TIPE_ORDERLabel').value != str){
			document.getElementById('No_PolisiLabel1').value='';
			document.getElementById('Id_Internal_OrderLabel1').value='';
			document.getElementById('NIK_Supir1').value='';
			document.getElementById('Nama_Supir1').value='';
			
			document.getElementById('NIK_TM1').value='';
			document.getElementById('NIK_TM2').value='';
			document.getElementById('NIK_TM3').value='';
			
			document.getElementById('Nama_TM1').value='';
			document.getElementById('Nama_TM2').value='';
			document.getElementById('Nama_TM3').value='';
		}else{
			document.getElementById('NIK_TM1').value=document.getElementById('tmp_NIK_TM1').value;
			document.getElementById('NIK_TM2').value=document.getElementById('tmp_NIK_TM2').value;
			document.getElementById('NIK_TM3').value=document.getElementById('tmp_NIK_TM3').value;
			
			document.getElementById('Nama_TM1').value=document.getElementById('tmp_Nama_TM1').value;
			document.getElementById('Nama_TM2').value=document.getElementById('tmp_Nama_TM2').value;
			document.getElementById('Nama_TM3').value=document.getElementById('tmp_Nama_TM3').value;	
		}
    }else if(str == "EXTERNAL"){
		show_eksternal();
		hide_internal();
		if(document.getElementById('TIPE_ORDERLabel').value != str){
			document.getElementById('No_PolisiLabel2').value='';
			document.getElementById('Id_Internal_OrderLabel2').value='';
			document.getElementById('Nama_Supir2').value='';
...
function GetDate(str) {
	...
	var formatddate = arr[0] + '-' + month + '-' + '20' + arr[2];
	return formatddate;
}
...
function validateInput(elem){
	...
	if (document.getElementById("datepicker").value == ""){	
		...
		if (tgl.indexOf(str) != -1) {
			var tgl_kirim = GetDate(tgl);
		} else {
      ...
      <table border="0" id="setbody2">
        ...
        ?>
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td width="303" valign="top"><input name="tmp_Nama_TM1" type="hidden" id="tmp_Nama_TM1"/>
				<input name="Nama_TM1" type="text" id="Nama_TM1" value="<?=$Nama_TM1?>" onChange='push_data();' style="width: 300px; height:25px; font-size:15px" onClick='javascript:showListTkgMuat1(1);' readonly='readonly'/>
          </script><span class="f_alertRed10px" id="alert_txtNamaTM1"></span></td><td>&nbsp;</td>
            <td>NIK Tukang Muat 1</td>
            <td>:</td>
            <td><input name="tmp_NIK_TM1" type="hidden" id="tmp_NIK_TM1"/>
				<input name="NIK_TM1" type="text" id="NIK_TM1" value="<?=$NIK_TM1?>" onChange='push_data();' style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td width="303" valign="top"><input name="tmp_Nama_TM2" type="hidden" id="tmp_Nama_TM2"/>
			<input name="Nama_TM2" type="text" id="Nama_TM2" onChange='push_data();' value="<?=$Nama_TM2?>" style="width: 300px; height:25px; font-size:15px" onClick='javascript:showListTkgMuat2(1);' readonly='readonly'/></td>
            <td>&nbsp;</td>
            <td>NIK Tukang Muat 2</td>
            <td>:</td>
            <td><input name="tmp_NIK_TM2" type="hidden" id="tmp_NIK_TM2"/>
			<input name="NIK_TM2" type="text" id="NIK_TM2" value="<?=$NIK_TM2?>" onChange='push_data();' style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td valign="top">:</td>
            <td width="303" valign="top"><input name="tmp_Nama_TM3" type="hidden" id="tmp_Nama_TM3"/>
			<input name="Nama_TM3" type="text" id="Nama_TM3" value="<?=$Nama_TM3?>" onChange='push_data();' style="width: 300px; height:25px; font-size:15px"  onClick='javascript:showListTkgMuat3(1);' readonly='readonly'/></td>
            <td>&nbsp;</td>
            <td>NIK Tukang Muat 3</td>
            <td>:</td>
            <td><input name="tmp_NIK_TM3" type="hidden" id="tmp_NIK_TM3"/>
			<input name="NIK_TM3" type="text" id="NIK_TM3" value="<?=$NIK_TM3?>" onChange='push_data();' style="background-color:#CCC; width: 300px; height:25px; font-size:15px" onmousedown="return false"/></td>
          </tr>
          <tr>
