...
<table width="1151" height="390" border="0" align="center">
  ...
  <tr>
    <th height="197" scope="row" align="center"><table width="937" border="0" id="setbody2">
      <tr>
		<td colspan="3" align="left" valign="baseline"><span style="font:bold; font-size:20px; font-weight: bold;"><strong>REGISTER NEW DEVICES</strong></span></td>
      </tr>
        <tr valign="middle">
  ...
  <tr>
	...
	echo "<td align=\"center\" style=\"font-size:12px\" >&nbsp;$ID_CC[$xJAN]</td>
			...
			<td align=\"center\" style=\"font-size:12px\" >&nbsp;$IMEI[$xJAN]</td>
			<td align=\"center\" style=\"font-size:12px\" >&nbsp;$NIK1[$xJAN]</td>
			<td align=\"center\" style=\"font-size:12px\" >&nbsp;$NAMA[$xJAN]</td>
				<td align=\"center\" style=\"font-size:12px\" > 
				
				<a href=\"editdevice.php?&id=$ID_DEV[$xJAN]\" onClick=\"return editbarang('$IMEI[$xJAN]');\">
				<input type=\"button\" name=\"button\" id=\"button\" value=\"Edit\"/>
				</a>
				
				
				<a href=\"delSubmitya.php?&id=$ID_DEV[$xJAN]\" onClick=\"return deletebarang('$IMEI[$xJAN]');\">
