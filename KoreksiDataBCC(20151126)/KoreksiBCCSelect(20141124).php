      ...
      <tr>
        <td align="center"><table width="995" border="0">
          ...
          <tr>
            ...
            <td width="7" height="29" valign="top" >:</td>
            <td width="355" align="left" valign="top" ><input name="Nama_Mandorlabel" type="text" id="Nama_Mandorlabel" value="<?=$NAMA_MANDOR?>" style="width: 300px; height:25px; font-size:15px" readOnly="readOnly"/><input name="NIK_Mandor" type="text" id="NIK_Mandor" value="<?=$NIK_MANDOR?>" style="background-color:#CCC; width:300px; height:25px; font-size:15px; display:none"></td>
            </tr>
          <tr>
			...
			<?php
					...
					while ($p=oci_fetch($result_blok)) {	
								  ...
								  if($id_blok == $ID_BLOK){
									echo "<input name='selectblok' type='text' id='selectblok' value='$id_blok - $blok_name' style='background-color:#CCC; width: 300px; height:25px; font-size:15px' onmousedown='return false'/>";
									//<option value=\"$id_blok\" selected='selected'>$id_blok - $blok_name</option>\n";
								  }//else{
        ...
        <td align="center">
          <table width="991" border="0" style="border:solid #556A29">
            ...
            <tr>
              ...
              <td width="7" height="29" valign="top" >:</td>
              <td width="355" align="left" valign="top" >
                <input name="NIK_Pemanen" type="text" id="NIK_Pemanen" value="<?=$NIK_Pemanen?>" style="width:300px; height:25px; font-size:15px" readOnly="readOnly"/>              </td>
              </tr>
          </table>        </td>
        </tr>
      <tr>
