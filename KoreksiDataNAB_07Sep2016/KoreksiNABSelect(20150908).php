      ...
      <table border="0" id="setbody2">
          ...
          <tr>
			...
			if($SessTIPE_ORDER == "EKSTERNAL"){
				...
				echo "<input name=\"No_PolisiLabel\" type=\"text\" id=\"No_PolisiLabel\" value=\"$sNO_POLISI\" style=\"width: 300px; height:25px; font-size:15px\" onchange=\"send(5)\" onblur=\"send(5)\"/>";
			}
			?>
			<script type="text/javascript">
					$(document).ready(function() {
