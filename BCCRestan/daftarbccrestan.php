...
$subID_BA_Afd = $_SESSION['subID_BA_Afd'];
	...
	//echo $sql_bcc_restan; die;
				...
				while(oci_fetch($result_t_bcc_restan)){
					...
					$TGL_REPORT[] 		= oci_result($result_t_bcc_restan, "TGL_REPORT"); 
					$TGL_PANEN[] 		= oci_result($result_t_bcc_restan, "TANGGAL_RENCANA"); 
					$BLOK[]   			= oci_result($result_t_bcc_restan, "ID_BLOK"); 
					$BLOK_NAME[]   		= oci_result($result_t_bcc_restan, "BLOK_NAME"); 
					$KERANI_BUAH[]   	= oci_result($result_t_bcc_restan, "NAMA_KERANI_BUAH");
					$NO_BCC[]   		= oci_result($result_t_bcc_restan, "NO_BCC");
					$BJR[]   			= oci_result($result_t_bcc_restan, "BJR");
...
function showData(value) {
	if(value != "tanggal"){
		...
		document.getElementById('titikdua1').style.visibility='hidden';
		document.getElementById('titikdua1').style.display='none';
		...
		document.getElementById('titikdua1').style.visibility='visible';
		document.getElementById('titikdua1').style.display='block';
  ...
  <tr>
    <th height="197" scope="row" align="center"><table width="937" border="0" id="setbody2">
      ...
      <tr>
		...
		<td height="45" colspan="3" valign="bottom" style="border-bottom:solid #000"><div id='periode' <?php if($_GET['rbtn_type'] <> '' && $_GET['rbtn_type'] <> 'tanggal'){echo "style='visibility: hidden; display: none'";} ?> >PERIODE</div></td>
        </tr>
	  ...
	  <tr>
		...
		<td width="70" height="29" valign="top" ><div id='start' <?php if($_GET['rbtn_type'] <> '' && $_GET['rbtn_type'] <> 'tanggal'){echo "style='visibility: hidden; display: none'";} ?> >Start Date</div></td>
		<td width="10" height="29" valign="top" ><div id='titikdua1' <?php if($_GET['rbtn_type'] <> '' && $_GET['rbtn_type'] <> 'tanggal'){echo "style='visibility: hidden; display: none'";} ?> >:</div></td>
		<td width="100" valign="top" ><input type="text" name="date1" <?php if($_GET['rbtn_type'] <> '' && $_GET['rbtn_type'] <> 'tanggal'){echo "style='visibility: hidden; display: none'";} ?> id="datepicker" class="box_field" <?php if(isset($_POST["date1"])){ echo "value='$_POST[date1]'"; }else{if (isset($_GET[date1])){ echo "value='$_GET[date1]'"; }}?>></td>
	  </tr>
	  <tr>
		...
		<td width="70" height="29" valign="top" ><div id='end' <?php if($_GET['rbtn_type'] <> '' && $_GET['rbtn_type'] <> 'tanggal'){echo "style='visibility: hidden; display: none'";} ?> >End Date</div></td>
		<td width="10" height="29" valign="top" ><div id='titikdua2' <?php if($_GET['rbtn_type'] <> '' && $_GET['rbtn_type'] <> 'tanggal'){echo "style='visibility: hidden; display: none'";} ?> >:</div></td>
		<td width="100" valign="top" ><input type="text" name="date2" <?php if($_GET['rbtn_type'] <> '' && $_GET['rbtn_type'] <> 'tanggal'){echo "style='visibility: hidden; display: none'";} ?> id="datepicker2" class="box_field" <?php if(isset($_POST["date2"])){ echo "value='$_POST[date2]'"; }else{if (isset($_GET[date2])){ echo "value='$_GET[date2]'"; }}?>></td>
		</tr>
		<tr>
		<td width="70" height="29" valign="top" >Jenis Laporan</td>
		<td width="10" height="29" valign="top" >:</td>	
		<td colspan='3'>
		<input type="radio" name="rbtn_type" id="rbtn_type" value="tanggal" <?php if($_GET['date1'] <> '1970-01-01' || $_GET['rbtn_type'] == 'tanggal'){echo "checked='checked'";} ?> onClick="showData('tanggal');">Restan per tanggal panen<br>
		<input type="radio" name="rbtn_type" id="rbtn_type" value="315" <?php if($_GET['rbtn_type'] == '315'){echo "checked='checked'";} ?> onClick="showData('315');">Saldo Restan 3 s/d 15 Hari<br>
		<input type="radio" name="rbtn_type" id="rbtn_type" value="1630" <?php if($_GET['rbtn_type'] == '1630'){echo "checked='checked'";} ?> onClick="showData('1630');">Saldo Restan 16 s/d 30 Hari
		</td>
		</tr></form>
	  ...
	  <tr>
        ...
        <td colspan="6" valign="top">
          ...
          <?php
		  if(isset($_GET['rbtn_type'])){
			  $_SESSION['rbtn_type'] = $_GET['rbtn_type'];
		  }
if($rowBCCRestan > 0){
...
echo "
		<table width=\"1134\" border=\"1\" bordercolor=\"#9CC346\">
          <tr bgcolor=\"#9CC346\">
            <td width=\"50\" align=\"center\" style=\"font-size:14px \" id=\"bordertable\">No</td>
			<td width=\"75\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Tgl Report</td>
			<td width=\"75\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Tgl Panen</td>
            ...
            <td width=\"150\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Nama Krani Buah</td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Kode Blok</td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Nama Blok</td>
			<td width=\"150\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">No.BCC</td>
			<td width=\"150\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">BJR</td>
			<td width=\"80\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">TBS Kirim(JJG)</td>
...
echo "<td align=\"center\" style=\"font-size:12px\" id=\"bordertable\">&nbsp;$no</td>
            <td align=\"center\" style=\"font-size:12px\" id=\"bordertable\">&nbsp;$TGL_REPORT[$xJAN]</td>
			...
			<td align=\"center\" style=\"font-size:12px\" id=\"bordertable\">&nbsp;$KERANI_BUAH[$xJAN]</td>
			<td align=\"center\" style=\"font-size:12px\" id=\"bordertable\">&nbsp;$BLOK[$xJAN]</td>
			<td align=\"center\" style=\"font-size:12px\" id=\"bordertable\">&nbsp;$BLOK_NAME[$xJAN]</td>
			<td align=\"center\" style=\"font-size:12px\" id=\"bordertable\">&nbsp;$fixedBCC</td>
		    <td align=\"center\" style=\"font-size:12px\" id=\"bordertable\">&nbsp;$BJR[$xJAN]</td>
