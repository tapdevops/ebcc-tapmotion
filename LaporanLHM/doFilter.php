...
if(isset($_SESSION["Afdeling"]) || isset($_SESSION["NIKMandor"]) || isset($_SESSION["NIKPemanen"]) || isset($_POST["date1"])){
		...
		if($rbtn_type == "Detail"){
			$sql_Laporan_LHM = "	
				SELECT tc.id_cc,
					 ...
					 NVL (F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 4), 0) AS OVR,
					 NVL (F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 6), 0) AS BB,
					 NVL (F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 15), 0) AS JK,
					 ...
					 NVL (F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 9), 0) AS MH,
			...
			if($rbtn_filter == "Pemanen"){
				$sql_Laporan_LHM = "SELECT tgl_panen,
                            ...
                            GROUP BY tgl_panen, nik_pemanen, nama_pemanen, id_blok
                            ORDER BY tgl_panen, nik_pemanen )  GROUP BY tgl_panen, nik_pemanen, nama_pemanen
				  ...
				  FROM (  SELECT tgl_panen,
							...
							FROM (  SELECT tc.id_cc,
								...
								GROUP BY tc.id_cc,
										 ...
										 zb.planted,
										 tdrp.no_rekap_bcc,
										 F_GET_HASIL_PANEN_BUNCH (TBA.ID_BA, thp.no_rekap_bcc, thp.no_bcc, 'BUNCH_HARVEST'), 
										 F_GET_HASIL_PANEN_BRDX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 1),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 2),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 3),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 4),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 6),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 15),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 16),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 7),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 9),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 11),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 12),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 13),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 10),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 14),
										 F_GET_HASIL_PANEN_NUMBERX (thrp.id_rencana, thp.no_rekap_bcc, thp.no_bcc, 8)
									ORDER BY tgl_panen,
										   id_afd,
										   id_blok,
										   nama_pemanen,
	...
	ORDER BY id_blok";
		...
		//echo $sql_Laporan_LHM."<br/>".$rbtn_filter;
		//die();
