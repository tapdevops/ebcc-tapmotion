		...
		if($roweffec > 0){
			...
			if($rbtn_type == "Detail"){
				...
				$objPHPExcel->setActiveSheetIndex(0)
							...
							->setCellValue("U$x", "$TP[$y]")
							->setCellValue("V$x", "$MH[$y]")
							->setCellValue("W$x", "$BT[$y]")
							->setCellValue("X$x", "$BL[$y]")
							->setCellValue("Y$x", "$PB[$y]")
							->setCellValue("Z$x", "$AB[$y]")
							->setCellValue("AA$x", "$SF[$y]")
							->setCellValue("AB$x", "$BS[$y]");
				...
				if($rbtn_filter == "Pemanen"){
					...
					$objPHPExcel->setActiveSheetIndex(0)
								...
								->setCellValue("M$x", "$TP[$y]")
								->setCellValue("N$x", "$MH[$y]")
								->setCellValue("O$x", "$BT[$y]")
								->setCellValue("P$x", "$BL[$y]")
								->setCellValue("Q$x", "$PB[$y]")
								->setCellValue("R$x", "$AB[$y]")
								->setCellValue("S$x", "$SF[$y]")
								->setCellValue("T$x", "$BS[$y]");	
					} 
				}else{
					$objPHPExcel->setActiveSheetIndex(0)
					->mergeCells("A".(1).":A".(2))
