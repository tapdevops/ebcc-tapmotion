	...
	if($username == ""){
		...
		if($KoreksiDataAAP == TRUE){
			...
			if(isset($_POST["submitvalue"]) == 1){
				$sql_t_hpk = "SELECT thrp.id_rencana,
							...
							GROUP BY  thrp.id_rencana,
									 thrp.tanggal_rencana,
									 ta.id_afd,
									 NIK_Pemanen,
									 f_get_empname (NIK_Pemanen)
			...
			//echo $sql_t_hpk."<br/><br/>".$sql_t_hpk_x; die();
...
{
	echo "<table cellspacing=0 border=\"1\" bordercolor=\"#9CC346\" class=\"scroll\">
		  <thead><!--<tbody id=\"scrolling3\" style=\"width:1083px\">-->";
}

echo "<tr class=\"complex-top\" bgcolor=\"#9CC346\" >
		    <th width=\"100px\" rowspan='2' align=\"center\" style=\"font-size:14px; \" class=\"third\"><div class=\"th-inner\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Tanggal</div></th>
            <th width=\"50px\" rowspan='2' align=\"center\" style=\"font-size:14px; \" class=\"third\"><div class=\"th-inner\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;AFD</div></th>
			<th width=\"300px\" colspan='2' align=\"center\" style=\"font-size:14px; \" class=\"third\"><div class=\"th-inner\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Pemanen</div></th>
			<th width=\"150px\" rowspan='2' align=\"center\" style=\"font-size:14px; \" class=\"third\"><div class=\"th-inner\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Koreksi</div></th>
          </tr>
          <tr class=\"complex-bottom\" bgcolor=\"#9CC346\">
            <th  width=\"150px\" align=\"center\" style=\"font-size:14px; \" class=\"third\"><div class=\"th-inner\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NIK</div></th>
            <th  width=\"150px\" align=\"center\" style=\"font-size:14px; \" class=\"third\"><div class=\"th-inner\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NAMA</div></th>
          </tr></thead><tbody>";
...
echo "
	...
	<td id=\"bordertable\" width=\"100px\">
		<form id=\"formIDRENCANA$xJAN\" name=\"formIDRENCANA$xJAN\" method=\"post\" action=\"KoreksiAAPSelect.php\">
		<input name=\"editID_RENCANA\" type=\"text\" id=\"editID_RENCANA\" value=\"$viewID_Rencana[$xJAN]\" style=\"display:none\"/>
		<input name=\"editTGL_RENCANA\" type=\"text\" id=\"editTGL_RENCANA\" value=\"$viewTanggal_Rencana[$xJAN]\" style=\"display:none\"/>
		<input name=\"editNIK_PEMANEN\" type=\"text\" id=\"editNIK_PEMANEN\" value=\"$viewNIK_PEMANEN[$xJAN]\" style=\"display:none\"/>
		<input name=\"editNAMA_PEMANEN\" type=\"text\" id=\"editNIK_PEMANEN\" value=\"$viewNAMA_PEMANEN[$xJAN]\" style=\"display:none\"/>
		$btn
		</form>
	</td>
	</tr>";	
