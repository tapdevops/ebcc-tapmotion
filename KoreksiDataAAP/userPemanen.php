...
$sql_t_Emp_All  = "
    ...
    WHERE (UPPER(TE.EMP_NAME) LIKE UPPER('%".$search."%') OR TE.NIK LIKE '%".$search."%')
	AND TE.JOB_CODE IN ('SUPIR','OPERATOR BACKHOE LOADER','OPERATOR BULLDOZER','OPERATOR COMPACTOR','OPERATOR EXCAVATOR','OPERATOR GENSET','OPERATOR GRADER','OPERATOR TRACTOR','PEKERJA BIBITAN','PEKERJA RAWAT','PEMANEN','TUKANG MUAT')
