...
function formSubmitvalue123(x,y)
{
	...
	if(x == 2){
		...
		var jml_gandeng = '<?= $rec_jml_gandeng ?>';
		var jml_max_gandeng = '<?= $max_jml_gandeng ?>';
		//alert(jml_gandeng+' '+jml_max_gandeng);
		if(jml_gandeng>=jml_max_gandeng){
        ...
        <td colspan="2" align="center" style="border-bottom:solid #000">
          <table width="991" border="0" id="setbody2">
			...
			<tr>
              <td>Luasan Panen</td>
              <td>	<span style="font-size:16px">
					<input name="Luasan_Panen" type="text" id="Luasan_Panen" value="<?=$_SESSION["val_luasan_panen"]?>" <?=$EditLuasan?>/>
              		</span>
              Ha</td>
            </tr>
            <tr>
