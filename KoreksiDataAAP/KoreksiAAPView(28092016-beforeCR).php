...
if($roweffec_hpk < 10)
{
	echo "<table width=\"1100px\"  border=\"0\" bordercolor=\"#9CC346\">
		  <tbody id=\"scrolling3\" style=\"width:1100px\">";
}
else
{
	echo "<table width=\"1100px\"  border=\"0\" bordercolor=\"#9CC346\">
		  <tbody id=\"scrolling3\" style=\"width:1083px\">";
}

echo "<tr bgcolor=\"#9CC346\" >
		    <td width=\"75px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Tanggal</td>
            <td width=\"75px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">AFD</td>
            <td width=\"75px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Blok</td>
            <td width=\"400px\" colspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Kerani Buah</td>
			<td width=\"400px\" colspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Mandor</td>
			<td width=\"400px\" colspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Pemanen</td>
            <td width=\"75px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Luasan Panen(Ha)</td>
            <td width=\"200px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \"  id=\"bordertable\">NIK Gandeng</td>
			<td width=\"100px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \"  id=\"bordertable\">Koreksi</td>
          </tr>
          <tr bgcolor=\"#9CC346\">
            <td width=\"200px\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">NIK</td>
            <td width=\"200px\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">NAMA</td>
			<td width=\"200px\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">NIK</td>
            <td width=\"200px\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">NAMA</td>
			<td width=\"200px\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">NIK</td>
            <td width=\"200px\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">NAMA</td>
...
echo "<tr style=\"font-size:14px; visibility:hidden\" bgcolor=$bg >";
echo "
	<td width=\"75px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >&nbsp;$viewTanggal_Rencana[$xJAN]</td>
	<td width=\"75px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >&nbsp;$viewID_AFD[$xJAN]</td>
	<td width=\"75px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >&nbsp;$viewID_BLOK[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >&nbsp;$viewNIK_KERANI_BUAH[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >$viewNAMA_KERANI_BUAH[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >&nbsp;$viewNIK_MANDOR[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >$viewNAMA_MANDOR[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >&nbsp;$viewNIK_PEMANEN[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >$viewNAMA_PEMANEN[$xJAN]</td>
	<td width=\"75px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >&nbsp;$viewLUASAN_PANEN[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px; visibility:hidden\" align=\"center\" >&nbsp;$viewNIK_GANDENG[$xJAN]</td>
...
echo "<table width=\"1100px\"  border=\"0\" bordercolor=\"#9CC346\">
		  ...
		  <tr bgcolor=\"#9CC346\" style=\"visibility:collapse\">
		    <td width=\"75px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Tanggal</td>
            <td width=\"75px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">AFD</td>
            <td width=\"75px\" rowspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Blok</td>
            <td width=\"400px\" colspan=\"2\" align=\"center\" style=\"font-size:14px; \" id=\"bordertable\">Kerani Buah</td>
...
echo "<tr style=\"font-size:14px\" bgcolor=$bg >";
	...
	NIK_PEMANEN = '".$viewNIK_PEMANEN[$xJAN]."' AND ((EXPORT_STATUS IS NOT NULL AND EXPORT_TIMESTAMP IS NOT NULL)
...
echo "
	<td width=\"75px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$viewTanggal_Rencana[$xJAN]</td>
	<td width=\"75px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$viewID_AFD[$xJAN]</td>
	<td width=\"75px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$viewID_BLOK[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$viewNIK_KERANI_BUAH[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">$viewNAMA_KERANI_BUAH[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$viewNIK_MANDOR[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">$viewNAMA_MANDOR[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$viewNIK_PEMANEN[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">$viewNAMA_PEMANEN[$xJAN]</td>
	<td width=\"75px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$viewLUASAN_PANEN[$xJAN]</td>
	<td width=\"200px\" style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$viewNIK_GANDENG[$xJAN]</td>
	<form id=\"formIDRENCANA$xJAN\" name=\"formIDRENCANA$xJAN\" method=\"post\" action=\"KoreksiAAPSelect.php\">
		<input name=\"editID_RENCANA\" type=\"text\" id=\"editID_RENCANA\" value=\"$viewID_Rencana[$xJAN]\" style=\"display:none\"/>
		<input name=\"editID_BLOK\" type=\"text\" id=\"editID_BLOK\" value=\"$viewID_BLOK[$xJAN]\" style=\"display:none\"/>
		<input name=\"editID_AFD\" type=\"text\" id=\"editID_AFD\" value=\"$viewID_AFD[$xJAN]\" style=\"display:none\"/>
...
echo "</tr>
<tr>
		<td colspan='9'><br>*Tidak Dapat Dikoreksi = Terdapat BCC yang telah di-export / sudah di-posting</td>
	  </tr>";
echo "</tbody>
        </table>";
}
