							...
							FROM (  SELECT tanggal,
									  ...
									  FROM (              
										SELECT TN.TGL_NAB TANGGAL,
													   ...
													   (SUM(F_GET_HASIL_PANEN_BUNCH(TBA.ID_BA, THP.NO_REKAP_BCC, THP.NO_BCC, 'BUNCH_SEND')) 
														* F_GET_BJR (TB.ID_BLOK, THRP.TANGGAL_RENCANA, TDRP.ID_BA_AFD_BLOK)) estimasi_berat,                             
...
echo "<table width=\"1100px\"  border=\"1\" bordercolor=\"#9CC346\">
          ...
          <tr bgcolor=\"#9CC346\">
            ...
            <td width=\"100px\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">TBS Kirim (jjg)</td>
