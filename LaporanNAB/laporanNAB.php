	...
	if($NIK == ""){
		...
		if($rbtn_type == "Rekap"){
			while(oci_fetch($result_laporan_NAB))
			{
				...
				$ID_BLOK[] 			= OCI_RESULT($result_laporan_NAB, "ID_BLOK");
				$BLOK_NAME[] 			= OCI_RESULT($result_laporan_NAB, "BLOK_NAME");
				$TAHUN_TANAM[] 			= OCI_RESULT($result_laporan_NAB, "TAHUN_TANAM");
				$BJR[] 			= OCI_RESULT($result_laporan_NAB, "BJR");
				$TTL_BCC[] 			= OCI_RESULT($result_laporan_NAB, "TTL_BCC");
				...
				$NAB_STATUS_EXPORT[] = OCI_RESULT($result_laporan_NAB, "NAB_STATUS_EXPORT");
			}
		}else{
			while(oci_fetch($result_laporan_NAB))
			{
				...
				$BCC_STATUS_EXPORT[] = OCI_RESULT($result_laporan_NAB, "BCC_STATUS_EXPORT");
				$NAB_STATUS_EXPORT[] = OCI_RESULT($result_laporan_NAB, "NAB_STATUS_EXPORT");
			}
		}	
...
if($rowNAB > 0){
	if($rbtn_type == "Rekap"){	
		//Edited by Ardo 29-09-2016 : Synchronize BCC - Laporan NAB
		echo "
		<table width=\"1150\" border=\"1\" bordercolor=\"#9CC346\">
		  <tr bgcolor=\"#9CC346\">
			<td width=\"75\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">&nbsp;&nbsp;Tanggal&nbsp;&nbsp;</td>
			<td width=\"10\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">No.NAB</td>
			<td width=\"10\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">NoPol</td>
			...
			<td width=\"10\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">BJR</td>
			<td width=\"20\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Tahun Tanam</td>
			<td width=\"100\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Total Bcc</td>
			<td width=\"100\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">TBS KIRIM (JJG)</td>
			...
			<td width=\"50\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Status NAB</td>
		  </tr>
		  <tr bgcolor=\"#9CC346\">
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">NIK</td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\"><p>Nama</p></td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">NIK</td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\"><p>Nama</p></td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">NIK</td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\"><p>Nama</p></td>
			...
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\"><p>Nama</p></td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">NIK</td>
			<td width=\"50\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Nama</td>
		...
		echo "	<td style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$TGL_PANEN[$xJAN]</td>
				...
				<td style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$TAHUN_TANAM[$xJAN]</td>
				<td style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$TTL_BCC[$xJAN]</td>
				...
				<td style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$NAB_STATUS_EXPORT[$xJAN]</td>
			";
		}
		echo "</tr></table>";
	}else{
		//Edited by Ardo 16-08-2016 : Synchronize BCC - Laporan NAB
		echo "
			<table width=\"1150\" border=\"1\" bordercolor=\"#9CC346\">
			  <tr bgcolor=\"#9CC346\">
				<td width=\"75\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">&nbsp;Tanggal&nbsp;&nbsp;</td>
				...
				<td width=\"50\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Estimasi Berat</td>
				<td width=\"50\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Status NAB</td>
				<td width=\"50\" rowspan=\"2\" align=\"center\" style=\"font-size:14px\" id=\"bordertable\">Status BCC</td>
			  </tr>
			  <tr bgcolor=\"#9CC346\">
			...
			echo "	<td style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$TGL_PANEN[$xJAN]</td>
					...
					<td style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$ESTIMASI_BERAT[$xJAN]</td>
					<td style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$NAB_STATUS_EXPORT[$xJAN]</td>
					<td style=\"font-size:12px\" align=\"center\" id=\"bordertable\">&nbsp;$BCC_STATUS_EXPORT[$xJAN]</td>
				";
			}
			echo "</tr></table>";
	}
